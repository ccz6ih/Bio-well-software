...
export const CHAKRA_DATA = [
  { id: 'root',   name: 'Root',       sanskrit: 'Muladhara',  center: 1, energy: 6.2, alignment: 87, color: '#ff4444', hue: 0,   val: 87, element: 'Earth',  desc: 'Adrenal gland, skeleton, backbone, kidney, rectum' },
  { id: 'sacral', name: 'Sacral',     sanskrit: 'Svadhisthana', center: 2, energy: 6.0, alignment: 98, color: '#ff8833', hue: 25,  val: 98, element: 'Water',  desc: 'Digestive apparatus, bowels, urogenital system' },
  { id: 'solar',  name: 'Solar Plex', sanskrit: 'Manipura',   center: 3, energy: 5.7, alignment: 79, color: '#ffdd44', hue: 50,  val: 79, element: 'Fire',   desc: 'Stomach, pancreas, excretory glands, liver' },
  { id: 'heart',  name: 'Heart',      sanskrit: 'Anahata',    center: 4, energy: 5.8, alignment: 99, color: '#44ee88', hue: 140, val: 99, element: 'Air',    desc: 'Cardiovascular system, lungs, thyroid gland' },
  { id: 'throat', name: 'Throat',     sanskrit: 'Vishuddha',  center: 5, energy: 6.3, alignment: 97, color: '#44ccff', hue: 200, val: 97, element: 'Sound',  desc: 'Spinal cord, throat, neck, oesophagus, heart' },
  { id: 'third',  name: 'Third Eye',  sanskrit: 'Ajna',       center: 6, energy: 4.3, alignment: 95, color: '#6688ff', hue: 240, val: 95, element: 'Light',  desc: 'Brain, hypophysis, hypothalamus, nervous system' },
  { id: 'crown',  name: 'Crown',      sanskrit: 'Sahasrara',  center: 7, energy: 4.8, alignment: 90, color: '#cc88ff', hue: 280, val: 90, element: 'Thought', desc: 'Brain, pineal gland, skin, hormone balance' },
]
...
export const SESSION_HISTORY = [
  { id: 1,  date: '2025-01-12', score: 58, stress: 47, vitality: 61, label: 'Jan 12' },
  { id: 2,  date: '2025-02-03', score: 60, stress: 45, vitality: 63, label: 'Feb 3'  },
  { id: 3,  date: '2025-02-19', score: 59, stress: 44, vitality: 62, label: 'Feb 19' },
  { id: 4,  date: '2025-03-07', score: 61, stress: 42, vitality: 64, label: 'Mar 7'  },
  { id: 5,  date: '2025-03-24', score: 64, stress: 39, vitality: 67, label: 'Mar 24' },
  { id: 6,  date: '2025-04-10', score: 63, stress: 37, vitality: 66, label: 'Apr 10' },
  { id: 7,  date: '2025-05-01', score: 67, stress: 35, vitality: 70, label: 'May 1'  },
  { id: 8,  date: '2025-05-18', score: 65, stress: 33, vitality: 72, label: 'May 18' },
  { id: 9,  date: '2025-06-01', score: 69, stress: 31, vitality: 74, label: 'Jun 1'  },
  { id: 10, date: '2025-06-10', score: 70, stress: 30, vitality: 75, label: 'Jun 10' },
  { id: 11, date: '2025-06-18', score: 68, stress: 30, vitality: 72, label: 'Jun 18' },
]
