      ...
      <div style={{ maxWidth: 700, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={panel}>
          ...
          <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
            <GhostButton onClick={() => { setCalDone(true); setTimeout(() => setCalDone(false), 3000) }}>
              ⊙ Recalibrate
            </GhostButton>
            {calDone && <span style={{ fontSize: 11, color: 'var(--bw-green)', animation: 'fade-in-up 0.3s ease both' }}>✓ Calibration complete</span>}
          </div>
        </div>
        ...
        <div style={panel}>
          ...
          <div style={{ marginTop: 14 }}>
            <GhostButton>+ New Patient Session</GhostButton>
          </div>
        </div>
